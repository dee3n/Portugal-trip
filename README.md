[index.html](https://github.com/user-attachments/files/25451473/Lisbon_Porto.html)
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .hero-note { display: inline-block; border: 1px solid rgba(242,100,25,0.35); padding: 10px 24px; border-radius: 100px; font-size: 0.88rem; color: rgba(250,246,239,0.75); font-style: italic; background: rgba(242,100,25,0.08); }
  ...
  /* SUB-BULLETS */
  .sub-bullets { list-style: none; margin-top: 6px; padding-left: 4px; }
  ...
  .sub-remove { background: none; border: none; color: #CCC; cursor: pointer; font-size: 0.78rem; padding: 0 2px; flex-shrink: 0; margin-left: auto; }
